...
**Seed** 8 · **Attempts** 1 · **Detective** Humphrey

## 1. The Truth

Agnes Sweeney, a photographer for the rotogravure section, named in the victim's will, killed Ernst Obermann, a bootlegger with the lease on the top floor, with a push from the roof garden in the Roof Garden at 9:30 PM. Agnes Sweeney needed the victim silent (silence-a-witness). Agnes Sweeney had been at the Front Desk earlier in the evening, before 9:30 PM and was alone with Ernst Obermann when it happened.

## 2. Dramatis Personae

| Name | Role | Relationship | Secret | Motive | Killer |
| --- | --- | --- | --- | --- | --- |
| Ernst Obermann | a bootlegger with the lease on the top floor | the victim | — | — | — |
| Konrad Hochstetter | a wine steward out of work since the Act | the victim's landlord | fence | property | — |
| Carmela Ruggiero | a piano teacher | the victim's rival in trade | forged-identity | — | — |
| Francis Quill | a stringer for the evening papers | the victim's private nurse | embezzling | debt | — |
| Assunta Bellucci | a dentist with rooms on the third floor | the victim's brother-in-law | blackmail | — | — |
| Delia Mulcahy | a stagehand at the Selwyn | the victim's estranged spouse | gambling-debt | — | — |
| Agnes Sweeney | a photographer for the rotogravure section | named in the victim's will | murder (+ forged-identity) | silence-a-witness | **YES** |
| Meyer Hurwitz | the doorman | fixture | — | — | — |
| Bernard Sirkin | the bartender | fixture | — | — | — |
...
- **Front Desk** (public) — adjacent: Lobby, Service Stairs; sees: Lobby; noise carries to: Lobby; objects: the roof door key, the guest register, the house ledger, a nickel-plated revolver
- **Bar** (public) — adjacent: Lobby, Kitchen; sees: Lobby, Kitchen; noise carries to: Lobby, Kitchen; objects: a seltzer siphon
- **Kitchen** (private) — adjacent: Bar, Service Stairs; sees: Bar; noise carries to: Bar, Service Stairs; objects: an ice pick, a mop and bucket
- **Service Stairs** (private) — adjacent: Kitchen, Lobby, Victim's Suite, Roof Garden, Front Desk; sees: nothing; noise carries to: Kitchen, Lobby; objects: none
...
**Environment:** Rain from 9:30 PM. Bar radio at 8:00 PM: the returns from the ward elections — the Ninth went the other way and the announcer said so twice.

## 4. Timelines

### Ernst Obermann — the victim
...
| Tick | Time | Meyer Hurwitz (the doorman) | Bernard Sirkin (the bartender) |
| --- | --- | --- | --- |
| 0 | 6:00 PM | Lobby | Bar |
| 1 | 6:30 PM | Lobby | Bar |
| 2 | 7:00 PM | Street | Bar |
| 3 | 7:30 PM | Lobby | Kitchen |
| 4 | 8:00 PM | Lobby | Bar |
| 5 | 8:30 PM | Lobby | Bar |
| 6 | 9:00 PM | Lobby | Bar |
| 7 | 9:30 PM | Lobby | Bar |
...
- **Konrad Hochstetter** (fence): Konrad Hochstetter hands a parcel of stolen goods to a man at the Kitchen at 9:30 PM.
- **Carmela Ruggiero** (forged-identity): Carmela Ruggiero is not the person the register says. Nothing is hidden about the evening; the lie is in the paperwork.
- **Francis Quill** (embezzling): Francis Quill goes through the papers in the Victim's Suite from 6:30 PM while the victim is downstairs.
- **Assunta Bellucci** (blackmail): Assunta Bellucci meets the victim alone in the Victim's Suite from 7:00 PM and asks for money.
- **Delia Mulcahy** (gambling-debt): Delia Mulcahy slips out to the Street from 9:30 PM to settle with a bookmaker.
- **Agnes Sweeney** (murder): Agnes Sweeney is alone with Ernst Obermann in the Roof Garden from 9:00 PM to 9:30 PM, and kills Ernst Obermann at 9:30 PM.
- **Agnes Sweeney** also (forged-identity): Agnes Sweeney is not the person the register says. Nothing is hidden about the evening; the lie is in the paperwork.
...
- Konrad Hochstetter — property: wanted the victim out of a lease.
- Francis Quill — debt: owed the victim money.
