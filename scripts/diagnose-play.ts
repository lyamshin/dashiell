...
function deathTicks(facts: Fact[]): Tick[] {
...
function clearsAt(f: Fact, s: Id, scene: Id, t: Tick): boolean {
...
function uncleared(kase: Case, facts: Fact[]): Id[] {
