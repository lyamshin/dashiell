...
export const SUSPECT_ARCHETYPES: Archetype[] = [
  /* ------------------------------------------------------------------ money */
  {
    ...
    professionFirst: [
      ...
      'I live on an allowance from the family. It comes on the first of the month. By the eighth it has gone somewhere nicer.',
      'I live on family money, and I keep a desk at a brokerage. Nobody there expects me before noon, and I have never once let them down.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I write a society column for the papers. Three columns a week, and I dine out for every one of them. I haven’t cooked since I learned to spell.',
      'I write a society column for the papers. I have a standing table at a place the bill never comes to. I have stopped looking up when the waiter passes.',
      'I write a society column for the papers. I keep a card index of everybody worth a paragraph. It is a small box, and it should be smaller.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I own the buildings on this street. Four of them, and I collect the rent in person. It’s harder to say no to my face.',
      'I own the buildings on this street. I carry the rent book around them myself, on the first of the month. It’s the one day everybody is home and nobody answers the door.',
  ...
  },
  {
    ...
    professionFirst: [
      'I write for the evening papers, freelance. I sell two hundred words at a time to whichever desk is short. I can make almost anything two hundred words long.',
      'I write for the evening papers, freelance. I work the precincts at night and the courts in the morning. I fit sleep in wherever there’s room.',
      'I write for the evening papers, freelance. I have a press card and no salary. The press card gets me in everywhere except a restaurant.',
    ],
  ...
  /* ---------------------------------------------------------------- working */
  {
    ...
    professionFirst: [
      'I am a chambermaid in a hotel. Eleven rooms a day, and the linen after. Nobody has ever made a bed for me.',
      'I am a chambermaid in a hotel. I have the third and fourth floors, and I am finished at four. Four is the best number in the hotel.',
      'I am a chambermaid in a hotel. Six years on the same floors, and I know every door on them. I could do the rounds with my eyes shut, and some mornings I do.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a seamstress. I finish coats at home by the piece, and the bundles go back on Fridays. By Thursday night I am sleeping on them.',
  ...
  },
  {
    ...
    professionFirst: [
      ...
      'I drive a cab. I own it, and I owe on it. It’s more owe than own.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I work backstage at the Selwyn. I work the ropes above the stage, and I am out by eleven. I have never once seen how a show ends.',
      'I work backstage at the Selwyn. I put up and take down the scenery for whatever is playing. If there is a wall on that stage, I put it there.',
      'I work backstage at the Selwyn. I have been on the same crew since the theatre opened. The actors change, and the crew doesn’t.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      ...
      'I am a switchboard operator at the telephone exchange. I know every number on the floor better than my own.',
  ...
  },
  {
    ...
    professionFirst: [
      'I am the night manager at the hotel. I have the desk from six at night until six in the morning. I have never seen the lobby with the sun in it.',
      'I am the night manager at the hotel. I run it while the day manager sleeps. He thinks he runs it, and we have never been awake at the same time to argue.',
  ...
  },
  {
    ...
    professionFirst: [
      'I dance in the chorus, between shows just now. I make the rounds of the agencies at eleven and I am home by one. It takes two hours to be told no by six people.',
      ...
      'I dance in the chorus, between shows just now. I rehearse when there is anything to rehearse for. The rest of the time I stretch and look hopeful.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I work for the local political club. I bring in the district’s votes, and I am paid in favours. I have never needed cash for anything a favour couldn’t do.',
      'I work for the local political club. I deliver the vote on the block, and the coal in February. November is when they remember the coal.',
      'I work for the local political club. I sit in the clubhouse and settle what can be settled there. Most things can, if everybody stays sitting down.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I work the door at a club with no sign on it. I know every face that comes to it. Most of them I would rather not.',
      ...
      'I work the door at a club with no sign on it. I am there from nine until they close. Nobody has ever asked me to leave early.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I collect bets for the numbers, an illegal lottery. I carry the slips between four corners and a candy store. I never buy anything at the candy store, on principle.',
