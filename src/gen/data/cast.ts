...
export const SUSPECT_ARCHETYPES: Archetype[] = [
  /* ------------------------------------------------------------------ money */
  {
    ...
    professionFirst: [
      'I live on family money. I have no occupation anybody can name, and an account at three tailors.',
      'I live on an allowance from the family. It comes on the first of the month and it is spent by the eighth.',
      'I live on family money, and I keep a desk at a brokerage. Nobody there expects me before noon.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a widow. I keep rooms on the avenue, and a girl comes in three mornings a week.',
      'I am a widow. I live on an annuity, and the rent from a house in Flushing.',
      'I am a widow. I have not worked since my marriage, and I do not mean to start.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I trade stocks on the street, outside the Exchange. In all weathers.',
      'I trade stocks on the street. My customers would rather not be seen doing it themselves.',
      'I trade stocks on the street. I carry three telephone numbers, and I have no office.',
    ],
    wants: ['money', 'money', 'to-be-somebody', 'to-keep-what-they-have'],
    visibleProfession: false,
  },
  {
    ...
    professionFirst: [
      'I write a society column for the papers. Three columns a week, and I dine out for all of them.',
      'I write a society column for the papers. I have a standing table at a place the bill never comes to.',
      'I write a society column for the papers. I keep a card index of everybody worth a paragraph.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I own the buildings on this street. Four of them, and I collect the rent in person.',
      'I own the buildings on this street. I carry the rent book around them myself, on the first of the month.',
      'I own the buildings on this street. I have a boilerman and a lawyer, and no partners.',
    ],
  ...
  /* ----------------------------------------------------------- professional */
  {
    ...
    professionFirst: [
      'I am a lawyer. I keep two rooms over a bank, and one clerk does the typing.',
      'I am a lawyer. I practise alone, and I take whatever walks up the stairs.',
      'I am a lawyer. I have a list of clients, and I will not read any of it aloud.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a bookkeeper. I keep the books for two firms, and a lodge.',
      'I am a bookkeeper. I sit the same desk, eight until six, and the columns are ruled by hand. My hand.',
      'I am a bookkeeper. I do the payroll on Thursdays, and the ledgers take the rest of the week.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a private nurse. I sit nights with patients the hospitals have sent home.',
      'I am a private nurse. I am on the registry, and I take the cases nobody else will.',
      'I am a private nurse. I nursed overseas, and I have not been out of work since.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a dentist. I have a chair, a waiting room, and a girl on the door.',
      'I am a dentist. I pull teeth for the neighbourhood, a dollar a time.',
      'I am a dentist. I bought the practice second-hand, and I am still paying for the chair.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a private secretary. I answer the letters and keep the diary, and I know what is in both.',
      'I am a private secretary. I have worked for three men in six years, and left none of them badly.',
      'I am a private secretary. I take the dictation, and I do the banking as well.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I write for the evening papers, freelance. I sell two hundred words at a time to whichever desk is short.',
      'I write for the evening papers, freelance. I work the precincts at night and the courts in the morning.',
      'I write for the evening papers, freelance. I have a press card and no salary.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I teach piano. I take pupils in the front room, four until seven, and I hear every scale twice.',
      'I teach piano at the settlement house. Three afternoons a week.',
      'I teach piano. I have eleven pupils, and a piano that wants tuning.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am an insurance adjuster. I inspect fires for the company and write up what the fire left.',
      'I am an insurance adjuster. I settle accident claims, and I am paid to doubt people. It is a living.',
      'I am an insurance adjuster. I have a district that runs from the river to Eighth Avenue.',
    ],
  ...
  /* ---------------------------------------------------------------- working */
  {
    ...
    professionFirst: [
      'I am a chambermaid in a hotel. Eleven rooms a day, and the linen after.',
      'I am a chambermaid in a hotel. I have the third and fourth floors, and I am finished at four.',
      'I am a chambermaid in a hotel. Six years on the same floors, and I know every door on them.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I work on the docks. The Elizabeth Street pier, when there is work.',
      'I work on the docks. I line up at the pier at seven to be picked, and I take whatever the boss hands out.',
      'I work on the docks. I have a cargo hook and a union button, and three days a week.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a seamstress. I finish coats at home by the piece, and the bundles go back on Fridays.',
      'I am a seamstress. I work a machine in a loft, and I am paid by the dozen.',
      'I am a seamstress. I sew for a fashion house on the avenue, and my name is never on the label.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I drive a cab. I wait for fares outside the hotel, six until the small hours.',
      'I drive a cab, nights. I sleep while the city works.',
      'I drive a cab. I own it, and I owe on it.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a tailor. I press coats and remake old ones, in a shop the width of a hallway.',
      'I am a tailor. I have a shop under the stairs, and a boy does the delivering.',
      'I am a tailor. I make suits to measure for men who pay their bill at Christmas.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I work backstage at the Selwyn. I work the ropes above the stage, and I am out by eleven.',
      'I work backstage at the Selwyn. I put up and take down the scenery for whatever is playing.',
      'I work backstage at the Selwyn. I have been on the same crew since the theatre opened.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am a switchboard operator. I sit the board, four until midnight, and I hear both ends of everything.',
      'I am a switchboard operator at the telephone exchange. I know every number on the floor.',
      'I am a switchboard operator. I plug the calls through, and I am not supposed to listen.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I am the night manager at the hotel. I have the desk from six at night until six in the morning.',
      'I am the night manager at the hotel. I run it while the day manager sleeps.',
      'I am the night manager at the hotel. I keep the register and the keys, and I remember who is not in the register.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I dance in the chorus, between shows just now. I make the rounds of the agencies at eleven and I am home by one.',
      'I dance in the chorus. Two seasons in the line, and I am waiting on a third.',
      'I dance in the chorus, between shows just now. I rehearse when there is anything to rehearse for.',
    ],
  ...
  /* ------------------------------------------------------------- underworld */
  {
    ...
    professionFirst: [
      'I take bets on the horses. In a small way, out of the back of a cigar store.',
      'I take bets on the horses. Four blocks, and no further.',
      'I take bets on the horses. I write the odds on a slate and rub them off before six.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I work for the local political club. I bring in the district’s votes, and I am paid in favours.',
      'I work for the local political club. I deliver the vote on the block, and the coal in February.',
      'I work for the local political club. I sit in the clubhouse and settle what can be settled there.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I write tickets at the pawnshop. I know what a thing is worth.',
      'I clerk at the pawnshop. I mind it while the broker is at the auctions.',
      'I clerk at the pawnshop. I hand back what people pay to get out of pawn, and sell what nobody comes back for.',
    ],
    wants: ['money', 'to-be-left-alone', 'to-keep-what-they-have'],
    visibleProfession: false,
  },
  {
    ...
    professionFirst: [
      'I work the door at a club with no sign on it. I know every face that comes to it.',
      'I work the door at a club with no sign on it. I keep the wrong people out and the right people quiet.',
      'I work the door at a club with no sign on it, from nine until they close.',
    ],
  ...
  },
  {
    ...
    professionFirst: [
      'I collect bets for the numbers, an illegal lottery. I carry the slips between four corners and a candy store.',
      'I collect bets for the numbers, an illegal lottery. I take the bets in the morning and pay the winners in the afternoon.',
      'I collect bets for the numbers, an illegal lottery run from uptown. They trust me with the money.',
    ],
...
export const FIXTURE_CARDS: Record<string, FixtureCard> = {
  bartender: {
    ...
    detailsFirst: [
      'I tend bar at {place}. Nine years, and I remember what everybody drinks.',
      'I tend bar at {place}, from four until they lock the door.',
      'I tend bar at {place}, six nights a week. Mondays are mine.',
    ],
  },
  doorman: {
    role: 'the doorman',
    ...
    detailsFirst: [
      'I work the door at {place}. I don’t write anybody down, and I don’t forget anybody.',
      'I work the door at {place}. I’ve had it since the building changed hands.',
      'I work the door at {place}, six until two. I see every face twice, going in and coming out.',
    ],
  },
  newsstand: {
    ...
    detailsFirst: [
      'I sell papers at {place}. I start before six and stay till the last edition’s gone.',
      'I sell papers at {place}. Twenty years, and I know every regular by the paper they take.',
      'I sell papers at {place}. Nothing crosses that pavement I don’t see.',
    ],
  },
  counterman: {
    ...
    detailsFirst: [
      'I work the counter at {place}, the evening shift.',
      'I work the counter at {place}, from four until midnight.',
      'I work the counter at {place}. Nobody’s ever once asked my name.',
    ],
  },
  'ticket-taker': {
    ...
    detailsFirst: [
      'I take tickets at {place}. I tear every one of them in half.',
      'I take tickets at {place}, from seven until the last show goes in.',
      'I take tickets at {place}. I have since the place opened.',
    ],
  },
  'elevator-man': {
    ...
    detailsFirst: [
      'I run the elevator at {place}. I know what floor you want before you say it.',
      'I run the elevator at {place}, from three until eleven.',
      'I run the elevator at {place}. Eleven years, and I’ve never lost a day.',
    ],
  },
  landlady: {
    role: 'the landlady',
    ...
    detailsFirst: [
      'I let the rooms at {place}. I sit where I can see the stairs.',
      'I let the rooms at {place}. Twenty-two years, and I know every board that creaks.',
      'I let the rooms at {place}, and I collect on Saturdays.',
    ],
  },
  'beat-cop': {
    ...
    detailsFirst: [
      'I walk a beat. The same eight corners every night, and I try every door on them.',
      'I walk a beat. Four years on this post, and I can time the round to the minute.',
      'I walk a beat. I came on at six and I go off at two, the same as every night.',
    ],
  },
  cabbie: {
    ...
    detailsFirst: [
      'I drive a cab off the stand at {place}. I take the fares as they come.',
      'I drive a cab off the stand at {place}. Six years, and I know every regular fare on it.',
      'I drive a cab off the stand at {place}, nights. I sleep in the mornings.',
    ],
  },
  druggist: {
    role: 'the druggist',
    ...
    tie: 'behind the counter at {place}',
    detailsFirst: [
      'I’m the druggist at {place}. I keep it open until eleven and fill what’s brought in.',
      'I’m the druggist at {place}. I’ve had it since before the war, and I know what everybody on the block takes.',
      'I’m the druggist at {place}. I stand the counter and write down every prescription twice.',
    ],
  },
};
...
export const JOB_WORDS: Record<string, RegExp> = {
  'arch-heir': /family money|allowance/i,
  'arch-widow': /\bwidow/i,
  ...
  'arch-lawyer': /\blawyer|practises/i,
