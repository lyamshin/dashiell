...
export const SECRET_TEMPLATES: SecretTemplate[] = [
  ...
  },
  {
    ...
    hints: [
      ...
      '{P} goes very quiet when the horse-race results are mentioned.',
    ],
    traces: [
      'Betting slips at {L} in {P}’s wallet, all of them losers, all of them this month.',
      'A bookmaker’s list of IOUs at {L} with {P}’s initials against four of them.',
    ],
    disqualifiers: [
      'The man who collects for the bookmaker is found and will say it: {P} was at {L} from {T} paying off eleven hundred dollars, a dollar at a time, and went nowhere near the killing.',
      'The bookmaker’s ledger at {L} has the payment entered against {P}’s name and the time beside it, from {T}, in the clerk’s own hand.',
    ],
  },
  {
    type: 'fence',
    label: 'Selling stolen goods',
    minTicks: 1,
    maxTicks: 2,
    partner: 'none',
    ...
    disqualifiers: [
      'The man at {L} who buys the stolen goods would rather talk than be held: {P} was there from {T} handing over a parcel of somebody else’s silver, which is a charge {P} will take over this one.',
  ...
  },
  {
    ...
    hints: [
      ...
      '{P} has sworn off drink, and mentions it before anybody asks.',
  ...
  },
  {
    ...
    partner: 'none',
    description:
      '{P} is not the person {P}’s identity papers say. Nothing about the evening is hidden; the lie is all in the paperwork.',
    hints: [
    ...
    disqualifiers: [
      ...
      'The papers are forged and the reason is plain: {P} was deported once already and does not mean to be deported twice.',
    ],
  },
  {
    type: 'dope',
    ...
    maxTicks: 2,
    partner: 'none',
    description: '{P} buys morphine at {L} from {T} and would rather be thought a murderer than a drug addict.',
    hints: [
    ...
    traces: [
      'A little paper packet of morphine at {L}, folded the way one particular hand folds them.',
  ...
  },
  {
    ...
    label: 'Organizing a union',
    minTicks: 2,
    maxTicks: 2,
    partner: 'none',
    description: '{P} is at {L} from {T} signing men up for a union, which is a firing offence and worse.',
    hints: [
      ...
      'A private detective agency has had a man following {P} for a fortnight.',
    ],
    traces: [
    ...
    disqualifiers: [
      'Forty men will swear to it if they have to: {P} was at {L} from {T} taking their names, and the only thing {P} is guilty of is starting a union.',
      'The agency’s own detective confirms it. He was watching {P} at {L} for the whole of it, from {T}, and wrote it up for his employer.',
    ],
  },
  {
    type: 'hidden-family',
    label: 'A secret child',
    minTicks: 1,
    maxTicks: 2,
    partner: 'none',
    ...
    traces: [
      'A bundle of receipts at {L} for a child’s room and board, monthly, eight years of them.',
    ...
    disqualifiers: [
      ...
      'The parish register at {L} has the christening in it, and the child’s keep paid up through the evening in question.',
    ],
  },
];
