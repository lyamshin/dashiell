...
export const METHOD_TEMPLATES: MethodTemplate[] = [
  {
    ...
    accessNote: 'had to get at the chloral and doctor the drink',
  ...
  },
  {
    ...
    sceneTrace: 'The lamp came down with him and the bulb is still warm in its socket, unbroken.',
  ...
  },
  {
    ...
    sceneTrace: 'The dust on the parapet is scored where his heels went over, and the scuff has not weathered.',
    accessNote: 'had to take the key to get the door open',
    soundNote: 'a shout and then something hitting the areaway',
  },
  {
    id: 'strangle',
    ...
    sceneTrace: 'His watch glass broke against the floor and the hands have not moved since.',
  ...
  },
  {
    ...
    sceneTrace: 'The cigarette he had going burned itself out on the sill where it fell.',
