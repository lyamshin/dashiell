 ...
 * lead mark if and only if it takes an open lead. Difficulty 3; the walk
...
describe('§8 every choice is valid, and the mark means a lead — difficulty 3', () => {
  it('parses, is accepted, costs its minutes, and is marked iff it takes a lead', () => {
    const { problems, checked } = walkChoices(3);
